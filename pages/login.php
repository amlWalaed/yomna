...
<body class="">
 <main class="flex flex-col items-center justify-center h-screen bg-indigo-500">
     <?php 
     if(count($errors)>0){
         echo '<div class="w-full max-w-sm p-2 mb-3 text-sm font-medium text-red-500 bg-indigo-200 rounded">';
    ...
    <form method="post" class="w-full max-w-sm p-6 space-y-6 border rounded shadow bg-white/20">
        ...
        <button type="submit"
        class="block px-2 py-1 mx-auto text-center text-white transition-colors duration-200 bg-indigo-900 rounded hover:bg-indigo-700">Start</button>
    </form>
 </main>
</body>
</html>